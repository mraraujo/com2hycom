...
public class MainOrkut {

	private static void init() {
		Constants.N = 219781800;
		Constants.D = 2;
		Constants.NS = new int[Constants.D];
		Constants.NS[0] = 3072441;
		Constants.NS[1] = 3072441;
		Constants.ELfile = "undorkut.nz";
	...
	public static void main(String[] args) throws IOException {
		init();
		FileWriter f = new FileWriter("hyperbola_orkut.csv");
